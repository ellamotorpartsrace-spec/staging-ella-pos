<?php
/**
 * api/shopee/log_stock_sync_summary.php — Record a single consolidated manual sync summary in shopee_sync_logs
 */
...
try {
    ...
    $stmt = $conn->prepare("
        ...
        VALUES 
            ('stock_update', 'Shopee Stock Allocation Sync', 'All Mapped Items', '—', ?, 'Live Sync Manual Fetch', ?, ?, NOW())
    ");
