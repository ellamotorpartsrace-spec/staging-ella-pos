...
while ($hasNext) {
    ...
    $output = shell_exec("c:\\xampp\\php\\php.exe -r \"session_start(); \\\$_SESSION['user_id']=1; \\\$_SESSION['role']='admin'; \\\$_GET['offset']=$offset; require 'c:/xampp/htdocs/ella-pos/ella-pos/api/lazada/fetch_products.php';\"");
