...
try {
    ...
    // Get used mappings
    $usedStmt = $conn->query("SELECT pos_product_id, pos_unit_id, pos_bundle_set_id FROM lazada_product_mappings WHERE pos_product_id IS NOT NULL OR pos_bundle_set_id IS NOT NULL");
