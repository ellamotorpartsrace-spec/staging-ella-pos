...
$unmappedRows = $conn->query("
    SELECT id, lazada_item_id, lazada_product_name, lazada_variation_name, lazada_stock, lazada_image_url,
        COALESCE(lazada_variation_sku, lazada_parent_sku,'') as sku
...
<div class="lz-animate" style="background: #f4f7fb; min-height: calc(100vh - 60px); padding-bottom: 3rem;">
    ...
    <div class="lz-allocation-hero position-relative overflow-hidden">
        <!-- Decorative Background Graphic -->
        <i class="fa-solid fa-sliders position-absolute text-white" style="font-size: 16rem; opacity: 0.04; right: -2%; top: -15%;"></i>
            ...
            <div class="d-flex justify-content-between align-items-end flex-wrap gap-3">
                <div>
                    <div class="lz-breadcrumb-light d-flex align-items-center gap-2 mb-3" style="font-size: 0.9rem;">
                        ...
                        <span style="opacity: 0.9;">Stock Allocation</span>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="mb-0 mt-1 text-white" style="opacity: 0.85; font-size: 1.05rem;">Allocate POS inventory to Lazada per variation. Only mapped products sync stock to Lazada.</p>
                        </div>
                    </div>
                </div>
                
                <div class="d-flex gap-2">
                    <button id="btnManualSync" class="btn bg-white shadow-sm fw-bold px-4 py-2 d-flex align-items-center gap-2" style="border-radius: 12px; font-size: 1rem; color: var(--lazada-primary); border: 1px solid rgba(255,255,255,0.8); transition: transform 0.2s;" onclick="triggerManualSync()" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
                        <i class="fa-solid fa-rotate"></i><span id="syncText">Sync Stock</span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-xl-3 col-md-6">
                <div class="bg-white p-4" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; border-bottom: 4px solid var(--lz-success); display: flex; align-items: center; gap: 1.2rem;">
                    ...
                    <div>
                        <div class="text-uppercase fw-bold" style="font-size: 0.85rem; color: #64748b; letter-spacing: 0.5px;">Allocated</div>
                        <div class="fw-bold" style="font-size: 1.8rem; color: #1e293b; line-height: 1.2;" id="sumAllocated">0</div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="bg-white p-4" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; border-bottom: 4px solid var(--lz-warning); display: flex; align-items: center; gap: 1.2rem;">
                    ...
                    <div>
                        <div class="text-uppercase fw-bold" style="font-size: 0.85rem; color: #64748b; letter-spacing: 0.5px;">Low Stock</div>
                        <div class="fw-bold text-warning" style="font-size: 1.8rem; line-height: 1.2;" id="sumLowStock">0</div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="bg-white p-4" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; display: flex; align-items: center; gap: 1.2rem;">
                    ...
                    <div>
                        <div class="text-uppercase fw-bold" style="font-size: 0.85rem; color: #64748b; letter-spacing: 0.5px;">Unallocated</div>
                        <div class="fw-bold" style="font-size: 1.8rem; color: #1e293b; line-height: 1.2;" id="sumUnallocated">0</div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="bg-white p-4" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; border-bottom: 4px solid var(--lz-danger); display: flex; align-items: center; gap: 1.2rem;">
                    ...
                    <div>
                        <div class="text-uppercase fw-bold" style="font-size: 0.85rem; color: #64748b; letter-spacing: 0.5px;">Overallocated</div>
                        <div class="fw-bold text-danger" style="font-size: 1.8rem; line-height: 1.2;" id="sumOverallocated">0</div>
                    </div>
                </div>
            </div>
        </div>
...
<div id="mappedSection">
    ...
    <div class="bg-white mb-4" id="globalFilterCard" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid #f1f5f9;">
        <div class="d-flex flex-wrap align-items-center gap-3" style="padding: 1rem 1.5rem;">
            <div class="lz-search flex-grow-1" style="max-width: 400px; position: relative;">
                ...
                <input type="text" id="allocSearch" autocomplete="off" placeholder="Search by name or SKU..." oninput="debouncedRender()" style="width: 100%; padding: 0.75rem 1rem 0.75rem 2.5rem; border-radius: 12px; border: 1px solid #e2e8f0; background: #f8fafc; font-size: 0.95rem; transition: all 0.2s;">
            </div>
            
            <div class="lz-filter-pills d-flex flex-wrap gap-2 ms-2">
                <button class="lz-pill active px-3 py-2 border-0 fw-bold rounded-pill" onclick="setAllocFilter('all',this)" style="background: transparent; color: #64748b; font-size: 0.9rem;"><i class="fa-solid fa-list me-1"></i>All</button>
                <button class="lz-pill px-3 py-2 border-0 fw-bold rounded-pill" onclick="setAllocFilter('manual',this)" style="background: transparent; color: #64748b; font-size: 0.9rem;"><i class="fa-solid fa-hand-pointer me-1 text-info"></i>Manually Mapped</button>
                <button class="lz-pill px-3 py-2 border-0 fw-bold rounded-pill" onclick="setAllocFilter('duplicate',this)" style="background: transparent; color: #64748b; font-size: 0.9rem;"><i class="fa-solid fa-clone me-1 text-danger"></i>Shared SKUs</button>
                <button class="lz-pill px-3 py-2 border-0 fw-bold rounded-pill" onclick="setAllocFilter('synced',this)" style="background: transparent; color: #64748b; font-size: 0.9rem;"><i class="fa-solid fa-check-circle me-1 text-success"></i>Allocated</button>
                <button class="lz-pill px-3 py-2 border-0 fw-bold rounded-pill" onclick="setAllocFilter('low',this)" style="background: transparent; color: #64748b; font-size: 0.9rem;"><i class="fa-solid fa-triangle-exclamation me-1 text-warning"></i>Low Stock</button>
                <button class="lz-pill px-3 py-2 border-0 fw-bold rounded-pill" onclick="setAllocFilter('unallocated',this)" style="background: transparent; color: #64748b; font-size: 0.9rem;"><i class="fa-solid fa-minus-circle me-1 text-secondary"></i>Unallocated</button>
                <button class="lz-pill px-3 py-2 border-0 fw-bold rounded-pill" onclick="setAllocFilter('overallocated',this)" style="background: transparent; color: #64748b; font-size: 0.9rem;"><i class="fa-solid fa-arrow-trend-up me-1 text-danger"></i>Overallocated</button>
            </div>
        </div>
    </div>
    <div class="bg-white overflow-hidden mb-4" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid #f1f5f9;">
        <div class="p-0 lz-table-wrap">
            <table class="lz-table table mb-0 align-middle" style="border-collapse: collapse;">
                <thead style="background: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                    <tr>
                        <th style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase;">Product / Variation</th>
                        <th style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Parent SKU</th>
                        <th style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Variation SKU</th>
                        <th class="text-center" style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Overall Stock</th>
                        <th class="text-center" style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Allocated</th>
                        <th class="text-center" style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Current Stock</th>
                        <th class="text-center" style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Status</th>
                        <th class="text-end" style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Action</th>
                    </tr>
                </thead>
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 p-3" id="mappedPaginationFooter" style="background: #f8fafc; border-top: 1px solid #e2e8f0;">
...
<div id="unmappedSection" style="display:none">
    <div class="bg-white overflow-hidden mb-4" style="border-radius: 16px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid #f1f5f9;">
            ...
            <table class="lz-table table mb-0 align-middle" style="border-collapse: collapse;">
                <thead style="background: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                    <tr>
                        ...
                        <th style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Parent SKU</th>
                        <th style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Variation SKU</th>
                        <th class="text-center" style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Current Lazada Stock</th>
                        <th class="text-end" style="padding: 1rem 1.5rem; font-weight: 700; color: #475569; font-size: 0.85rem; text-transform: uppercase; width: 1%; white-space: nowrap;">Action</th>
                    </tr>
                </thead>
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 p-3" id="unmappedPaginationFooter" style="background: #f8fafc; border-top: 1px solid #e2e8f0;">
            <div class="d-flex align-items-center gap-2">
                <span class="text-secondary small fw-bold">Items per page:</span>
                <select class="form-select form-select-sm" id="unmappedItemsPerPageSelect" onchange="changeUnmappedItemsPerPage(this.value)" style="width: auto; border-radius: 8px;">
                    <option value="10">10</option>
                    <option value="25" selected>25</option>
                    <option value="50">50</option>
                    <option value="100">100</option>
...
function renderMapped(){
    ...
    if(!totalItems){
        const msg=MAPPED_FLAT.length===0
            ?`<div class="text-center py-5 my-3"><i class="fa-solid fa-link text-secondary mb-3" style="font-size: 4rem; opacity: 0.15;"></i><h4 class="fw-bold" style="color: #1e293b;">No mapped products yet</h4><p class="text-secondary" style="font-size: 1.05rem;">Go to <a href="${window.BASE_URL}views/lazada/laz_mapping.php" class="text-lazada fw-bold text-decoration-none">Product Mapping</a> first.</p></div>`
            :`<div class="text-center py-5 my-3"><i class="fa-solid fa-filter text-secondary mb-3" style="font-size: 4rem; opacity: 0.15;"></i><h4 class="fw-bold" style="color: #1e293b;">No products match this filter</h4><p class="text-secondary mb-0" style="font-size: 1.05rem;">Try adjusting your search query or selecting a different filter.</p></div>`;
...
function renderUnmapped(){
    ...
    if(!UNMAPPED_GROUPS.length){
        body.innerHTML=`<tr><td colspan="5"><div class="text-center py-5 my-3"><i class="fa-solid fa-circle-check mb-3" style="font-size: 4rem; color: var(--lz-success); opacity: 0.2;"></i><h4 class="fw-bold" style="color: #1e293b;">All products are mapped!</h4><p class="text-secondary mb-0" style="font-size: 1.05rem;">You have successfully mapped all Lazada products.</p></div></td></tr>`;
    ...
    slice.forEach(g=>{
        ...
        if (isSimple) {
            ...
            html += `<tr class="lz-group-start">
                ...
                <td class="text-end"><a href="${window.BASE_URL}views/lazada/laz_mapping.php" class="btn btn-sm btn-outline-lazada px-3"><i class="fa-solid fa-link me-1"></i>Map Now</a></td>
            </tr>`;
        } else {
            // Parent Row
            html += `<tr class="lz-group-start">
