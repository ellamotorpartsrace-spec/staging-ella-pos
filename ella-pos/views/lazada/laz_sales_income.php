<?php
// views/lazada/laz_sales_income.php
$page_title = 'Lazada Store — Sales & Income';
...
.lz-sales-tab.active {
    color: var(--lazada-primary);
    border-bottom-color: var(--lazada-primary);
}
.lz-tab-content {
    display: none;
}
.lz-tab-content.active {
    display: block;
...
.lz-kpi-widget:hover .lz-kpi-widget-bg-icon {
...
.lz-kpi-widget.accent-lazada { border-bottom: 3px solid var(--lazada-primary); }
.lz-kpi-widget.accent-info { border-bottom: 3px solid #3b82f6; }
.lz-kpi-widget.accent-success { border-bottom: 3px solid #10b981; }
.lz-kpi-widget.accent-warning { border-bottom: 3px solid #f59e0b; }
...
.lz-kpi-widget:hover .lz-kpi-icon-bubble {
    transform: scale(1.1);
}
.bubble-lazada { background: rgba(238, 77, 45, 0.12); color: var(--lazada-primary); }
...
.lz-kpi-widget.accent-lazada:hover .lz-kpi-widget-bg-icon { color: var(--lazada-primary); opacity: 0.06; }
.lz-kpi-widget.accent-info:hover .lz-kpi-widget-bg-icon { color: #3b82f6; opacity: 0.06; }
.lz-kpi-widget.accent-success:hover .lz-kpi-widget-bg-icon { color: #10b981; opacity: 0.06; }
.lz-kpi-widget.accent-warning:hover .lz-kpi-widget-bg-icon { color: #f59e0b; opacity: 0.06; }

.lz-kpi-widget.grad-warning {
    background: var(--lz-grad-warning);
    border: none;
    color: #fff;
}
.lz-kpi-widget.grad-warning .lz-kpi-label,
.lz-kpi-widget.grad-warning .lz-kpi-value {
    color: #fff;
}
.lz-kpi-widget.grad-warning .lz-kpi-widget-bg-icon {
    color: #fff;
    opacity: 0.2;
}
...
.lz-search-wrapper .lz-filter-input {
    padding-left: 42px;
}
.lz-pagination-wrapper {
    display: flex;
...
<div class="lz-page lz-animate">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="lz-title mb-0"><i class="fa-solid fa-file-invoice-dollar text-lazada me-2"></i>LAZ INCOME</h1>
            <p class="text-secondary mb-0">Monitor your orders, fees, and true net profit</p>
        </div>
        <div class="d-flex gap-2">
            <button class="btn btn-outline-lazada" onclick="syncOrders()">
                <i class="fa-solid fa-rotate me-1"></i> Sync Orders
            </button>
            <button class="btn btn-lazada" onclick="syncFinances()">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-4 col-lg-2">
            <div class="lz-kpi-widget accent-lazada d-flex align-items-center">
                <div class="lz-kpi-icon-bubble bubble-lazada me-3"><i class="fa-solid fa-bolt"></i></div>
                <div>
                    <div class="lz-kpi-label">Today's Sales</div>
                    <div class="lz-kpi-value" id="kpiTodaySales">₱0.00</div>
                </div>
                <i class="fa-solid fa-arrow-trend-up lz-kpi-widget-bg-icon"></i>
            </div>
        </div>
        <!-- Today Orders -->
        <div class="col-6 col-md-4 col-lg-2">
            <div class="lz-kpi-widget accent-info d-flex align-items-center">
                <div class="lz-kpi-icon-bubble bubble-info me-3"><i class="fa-solid fa-box"></i></div>
                <div>
                    <div class="lz-kpi-label">Today's Orders</div>
                    <div class="lz-kpi-value" id="kpiTodayOrders">0</div>
                </div>
                <i class="fa-solid fa-boxes-stacked lz-kpi-widget-bg-icon"></i>
            </div>
        </div>
        <!-- Today True Net -->
        <div class="col-6 col-md-4 col-lg-2">
            <div class="lz-kpi-widget accent-success d-flex align-items-center">
                <div class="lz-kpi-icon-bubble bubble-success me-3"><i class="fa-solid fa-money-bill-wave"></i></div>
                <div>
                    <div class="lz-kpi-label">Today's True Net</div>
                    <div class="lz-kpi-value" id="kpiTodayNet">₱0.00</div>
                </div>
                <i class="fa-solid fa-sack-dollar lz-kpi-widget-bg-icon"></i>
            </div>
        </div>
        <!-- Month Sales -->
        <div class="col-6 col-md-4 col-lg-2">
            <div class="lz-kpi-widget accent-lazada d-flex align-items-center">
                <div class="lz-kpi-icon-bubble bubble-lazada me-3"><i class="fa-regular fa-calendar-check"></i></div>
                <div>
                    <div class="lz-kpi-label">Month's Sales</div>
                    <div class="lz-kpi-value" id="kpiMonthSales">₱0.00</div>
                </div>
                <i class="fa-solid fa-calendar-days lz-kpi-widget-bg-icon"></i>
            </div>
        </div>
        <!-- Month True Net -->
        <div class="col-6 col-md-4 col-lg-2">
            <div class="lz-kpi-widget accent-success d-flex align-items-center">
                <div class="lz-kpi-icon-bubble bubble-success me-3"><i class="fa-solid fa-piggy-bank"></i></div>
                <div>
                    <div class="lz-kpi-label">Month's True Net</div>
                    <div class="lz-kpi-value" id="kpiMonthNet">₱0.00</div>
                </div>
                <i class="fa-solid fa-piggy-bank lz-kpi-widget-bg-icon"></i>
            </div>
        </div>
        <!-- Pending to Ship -->
        <div class="col-6 col-md-4 col-lg-2">
            <div class="lz-kpi-widget accent-warning d-flex align-items-center">
                <div class="lz-kpi-icon-bubble bubble-warning me-3"><i class="fa-solid fa-clock-rotate-left"></i></div>
                <div>
                    <div class="lz-kpi-label">Pending to Ship</div>
                    <div class="lz-kpi-value" id="kpiPending">0</div>
                </div>
                <i class="fa-solid fa-truck-fast lz-kpi-widget-bg-icon"></i>
            </div>
        </div>
    </div>

    <!-- Toolbar Filters inside a Lazada Card -->
    <div class="lz-filter-bar mb-4">
        <div class="row g-3 align-items-end">
            <div class="col-sm-6 col-md-3 col-lg-2">
                <label class="lz-filter-label"><i class="fa-solid fa-calendar-day me-1 text-lazada"></i> Date Range</label>
                <select id="filterDateRange" class="form-select lz-filter-input" onchange="applyFilters()">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3" id="customDateContainer" style="display: none;">
                <div class="d-flex gap-2">
                    <div class="flex-fill">
                        <label class="lz-filter-label text-muted">From</label>
                        <input type="date" id="customFrom" class="form-control lz-filter-input">
                    </div>
                    <div class="flex-fill">
                        <label class="lz-filter-label text-muted">To</label>
                        <input type="date" id="customTo" class="form-control lz-filter-input">
                    </div>
                </div>
            </div>

            <div class="col-sm-6 col-md-3 col-lg-2">
                <label class="lz-filter-label"><i class="fa-solid fa-filter me-1 text-lazada"></i> Order Status</label>
                <select id="filterStatus" class="form-select lz-filter-input" onchange="applyFilters()">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3 flex-grow-1">
                <label class="lz-filter-label"><i class="fa-solid fa-magnifying-glass me-1 text-lazada"></i> Search Orders</label>
                <div class="lz-search-wrapper">
                    <i class="fa-solid fa-search"></i>
                    <input type="text" id="filterSearch" class="form-control lz-filter-input" placeholder="Order ID, SKU, or Product Name..." onkeyup="if(event.key==='Enter') applyFilters()">
                </div>
            </div>

            <div class="col-sm-12 col-md-auto">
                <button class="btn btn-lazada w-100 lz-filter-btn px-4" onclick="applyFilters()">
    ...
    <!-- Premium Tabs -->
    <div class="lz-pill-tabs">
        <a class="lz-pill-tab active" data-tab="tab-orders" href="#" onclick="switchTab(event, 'tab-orders')">
            <i class="fa-solid fa-list-ul"></i> Order List
        </a>
        <a class="lz-pill-tab" data-tab="tab-profit" href="#" onclick="switchTab(event, 'tab-profit')">
            <i class="fa-solid fa-chart-pie"></i> True Net Profit Analysis
        </a>
        <a class="lz-pill-tab" data-tab="tab-top" href="#" onclick="switchTab(event, 'tab-top')">
            <i class="fa-solid fa-crown"></i> Top Selling Products
        </a>
        <a class="lz-pill-tab" data-tab="tab-recon" href="#" onclick="switchTab(event, 'tab-recon')">
            <i class="fa-solid fa-scale-balanced"></i> Weekly Reconciliation
        </a>
    </div>

    <!-- Tab: Orders -->
    <div id="tab-orders" class="lz-tab-content active">
        <div class="lz-card">
            <div class="lz-table-wrap">
                <table class="lz-table" id="ordersTable">
                    <thead>
                        <tr>
                            <th>Order SN</th>
                            <th>Create Time</th>
            ...
            <div class="lz-card-footer lz-pagination-wrapper" id="ordersPagination"></div>
        </div>
    </div>

    <!-- Tab: Profit -->
    <div id="tab-profit" class="lz-tab-content">
        <div class="lz-card mb-4" style="border: 1px solid var(--lz-info); background: var(--lz-info-bg);">
            <div class="lz-card-body d-flex align-items-center gap-3 py-3 px-4">
                <div style="background: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                    <i class="fa-solid fa-lightbulb" style="color: var(--lz-info); font-size: 1.2rem;"></i>
                </div>
                <div>
                    <strong style="color: var(--lz-info); font-size: 0.95rem;">How True Net Profit Works</strong><br>
                    <span class="text-secondary small">This calculation takes the final Payout Amount from Lazada (Gross Sales minus all Lazada Fees) and subtracts your ERP's Capital Cost for the items sold.</span>
                </div>
            </div>
        </div>
        <div class="lz-card">
            <div class="lz-table-wrap">
                <table class="lz-table" id="profitTable">
                    <thead>
                        <tr>
                            <th>Order SN</th>
                            <th>Items Sold</th>
                            <th class="text-end">Lazada Payout (Net)</th>
            ...
            <div class="lz-card-footer lz-pagination-wrapper" id="profitPagination"></div>
        </div>
    </div>

    <!-- Tab: Top Selling -->
    <div id="tab-top" class="lz-tab-content">
        <div class="lz-card">
            <div class="lz-table-wrap">
                <table class="lz-table" id="topTable">
                    <thead>
                        <tr>
                            <th>SKU</th>
                            <th>Product Name</th>
            ...
            <div class="lz-card-footer lz-pagination-wrapper" id="topPagination"></div>
        </div>
    </div>

    <!-- Tab: Reconciliation -->
    <div id="tab-recon" class="lz-tab-content">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h5 class="mb-1 fw-bold" style="font-size: 1.1rem;"><i class="fa-solid fa-clipboard-check text-lazada me-2"></i>Weekly Audit & Reconciliation</h5>
            ...
            <button class="btn btn-outline-lazada" style="color: var(--lz-success); border-color: var(--lz-success);" onclick="exportReconciliation()">
        ...
        <div class="lz-card">
            <div class="lz-table-wrap">
                <table class="lz-table" id="reconTable">
                    <thead>
                        <tr>
                            <th>Order SN</th>
                            <th>Order Date</th>
            ...
            <div class="lz-card-footer lz-pagination-wrapper" id="reconPagination"></div>
        </div>
    </div>
        ...
        <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
            ...
            <div class="modal-body">
                <div class="d-flex align-items-center gap-2 mb-4">
                    <span class="lz-badge lz-badge-neutral" id="feeModalOrderSn">...</span>
                ...
                <div class="d-flex flex-column gap-2" style="font-size: 0.9rem;">
                    ...
                    <div class="mt-3 mb-1 text-danger fw-bold" style="font-size: 0.75rem; text-transform: uppercase;">Lazada Deductions</div>
                    <div class="d-flex justify-content-between text-secondary">
                    ...
                    <div class="d-flex justify-content-between text-secondary">
                        <span>Lazada Voucher</span>
                        <span class="text-success" id="feeLazadaVoucher">+₱0.00</span>
                    </div>

                    <div class="d-flex justify-content-between fw-bold pt-3 mt-2 border-top fs-5" style="color: var(--lazada-primary);">
            ...
            <div class="modal-footer border-0 pt-0">
                <button type="button" class="btn btn-lazada w-100" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
...
<div id="loadingOverlay" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(255,255,255,0.85); z-index:9999; align-items:center; justify-content:center; flex-direction:column; backdrop-filter: blur(3px);">
    <div style="background: white; padding: 2.5rem; border-radius: 16px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); text-align: center; max-width: 400px; width: 90%;">
        <div class="spinner-border text-lazada mb-3" role="status" style="width: 3rem; height: 3rem;">
            <span class="visually-hidden">Loading...</span>
        </div>
        <h4 class="fw-bold mb-2 text-dark" id="loadingTitle">Syncing Orders</h4>
        <p class="text-secondary small mb-0" id="loadingDesc">Fetching the latest orders and financial data from Lazada.<br><strong>Please do not close this page.</strong> This may take up to 60 seconds depending on your order volume.</p>
    </div>
</div>
...
function switchTab(event, tabId) {
    ...
    document.querySelectorAll('.lz-pill-tab').forEach(t => t.classList.remove('active'));
    document.querySelectorAll('.lz-tab-content').forEach(c => c.classList.remove('active'));
...
async function loadKPIs() {
    try {
        const res = await fetch(`${window.BASE_URL}api/lazada/get_sales_stats.php`);
...
async function applyFilters() {
    ...
    try {
        ...
        const [resOrders, resTop] = await Promise.all([
            fetch(`${window.BASE_URL}api/lazada/get_orders_list.php?${query.toString()}`),
            fetch(`${window.BASE_URL}api/lazada/get_top_products.php?${query.toString()}`)
        ]);
        ...
        document.getElementById('reconSummaryStats').innerHTML = `
            <span class="px-3 py-2 rounded" style="background: var(--lz-neutral-bg); border: 1px solid var(--border-color);"><i class="fa-solid fa-box text-secondary me-1"></i> Total Orders: ${allOrders.length}</span>
            <span class="px-3 py-2 rounded" style="background: var(--lz-success-bg); color: var(--lz-success); border: 1px solid rgba(16, 185, 129, 0.3);"><i class="fa-solid fa-check-circle me-1"></i> Completed: ${stats.completed}</span>
            <span class="px-3 py-2 rounded" style="background: var(--lz-danger-bg); color: var(--lz-danger); border: 1px solid rgba(239, 68, 68, 0.3);"><i class="fa-solid fa-triangle-exclamation me-1"></i> Missing Payouts: ${stats.missing_payout}</span>
            <span class="px-3 py-2 rounded" style="background: var(--lz-warning-bg); color: var(--lz-warning); border: 1px solid rgba(245, 158, 11, 0.3);"><i class="fa-solid fa-rotate-left me-1"></i> Returned: ${stats.returned}</span>
...
function buildPagination(type, totalItems) {
    ...
    let html = `
        ...
        <div>
            ...
            <button class="btn btn-sm btn-outline-lazada-secondary px-3" ${currentPage[type] === 1 ? 'disabled' : ''} onclick="changePage('${type}', -1)"><i class="fa-solid fa-chevron-left"></i></button>
            <button class="btn btn-sm btn-outline-lazada-secondary px-3 ms-1" ${currentPage[type] === totalPages ? 'disabled' : ''} onclick="changePage('${type}', 1)"><i class="fa-solid fa-chevron-right"></i></button>
        </div>
    `;
...
function renderOrders() {
    ...
    slice.forEach(o => {
        let finBadge = o.financial_status === 'RELEASED' ? '<span class="lz-badge lz-badge-success">Released</span>' : '<span class="lz-badge lz-badge-warning">Pending</span>';
        if(o.financial_status === 'REFUNDED') finBadge = '<span class="lz-badge lz-badge-danger">Refunded</span>';
        ...
        html += `
            <tr>
                ...
                <td><span class="lz-badge lz-badge-neutral">${o.order_status}</span></td>
    ...
    slice.forEach(o => {
        ...
        html += `
            <tr>
                ...
                <td class="text-end"><span class="lz-badge lz-badge-neutral border">${margin}%</span></td>
            </tr>
        `;
    });
...
function renderRecon() {
    ...
    slice.forEach(o => {
        ...
        let alertHtml = '';
        if((o.order_status === 'COMPLETED' || o.order_status === 'TO_CONFIRM_RECEIVE') && o.financial_status !== 'RELEASED') {
            alertHtml = '<span class="lz-badge lz-badge-danger"><i class="fa-solid fa-triangle-exclamation"></i> Missing Payout</span>';
        } else if (o.order_status === 'CANCELLED') {
            alertHtml = '<span class="lz-badge lz-badge-neutral">Cancelled (Failed/RTS)</span>';
        } else if (o.order_status === 'RETURN_REFUND') {
            alertHtml = '<span class="lz-badge lz-badge-warning">Return / Refund</span>';
        } else if (o.financial_status === 'RELEASED') {
            alertHtml = '<span class="lz-badge lz-badge-success"><i class="fa-solid fa-check"></i> Released to Bank</span>';
        } else {
        ...
        html += `
            <tr>
                ...
                <td>${o.create_time}</td>
                <td><span class="lz-badge lz-badge-neutral">${o.order_status}</span></td>
                <td>${o.financial_status ? `<span class="lz-badge ${o.financial_status === 'RELEASED' ? 'lz-badge-success' : 'lz-badge-warning'}">${o.financial_status}</span>` : '<span class="lz-badge lz-badge-neutral">NOT AVAILABLE</span>'}</td>
...
function renderTop() {
    ...
    slice.forEach(p => {
        ...
        html += `
            <tr>
                <td class="fw-bold"><span class="lz-sku-code">${p.item_sku || '-'}</span></td>
...
async function syncOrders() {
    ...
    try {
        ...
        const res = await fetch(`${window.BASE_URL}api/lazada/sync_orders.php?days=90`);
        const data = await res.json();
        if(data.success) {
...
async function syncFinances() {
    ...
    document.getElementById('loadingOverlay').style.display = 'flex';
    try {
        const res = await fetch(`${window.BASE_URL}api/lazada/sync_finances.php`);
        const data = await res.json();
        if(data.success) {
...
async function viewFeeBreakdown(orderSn) {
    document.getElementById('loadingOverlay').style.display = 'flex';
    try {
        const res = await fetch(`${window.BASE_URL}api/lazada/get_order_fees.php?order_sn=${orderSn}`);
        const data = await res.json();
        if(data.success) {
            const f = data.fees;
            ...
            document.getElementById('feeLazadaVoucher').textContent = '+' + formatCurrency(f.lazada_voucher);
