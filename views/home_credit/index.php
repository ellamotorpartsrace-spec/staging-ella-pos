...
$page_title = 'Home Credit Monitoring - Ella POS';
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-1 fw-bold text-dark"><i class="fa-solid fa-credit-card text-primary me-2"></i>Home Credit
            Monitoring</h4>
        <p class="text-muted mb-0 small">Track all sales processed via Home Credit installment.</p>
    </div>
</div>
    ...
    <div class="card-body p-3">
        <form id="filter-form" class="row g-3 align-items-end">
            ...
            <div class="col-12 col-md-2 d-flex gap-2">
                ...
                <button type="button" class="btn btn-outline-secondary btn-sm" onclick="HomeCreditTracker.reset()"
                    title="Reset Filters">
                    <i class="fa-solid fa-xmark"></i>
                </button>
                <button type="button" class="btn btn-success btn-sm" onclick="HomeCreditTracker.exportCSV()"
                    title="Export CSV">
...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body p-0">
        ...
        <div id="empty-state" class="text-center py-5 d-none">
            ...
            <h6 class="text-muted">No Home Credit sales found.</h6>
        </div>
...
<script>
    ...
    const HomeCreditTracker = {
        init() {
            this.form = document.getElementById('filter-form');
            this.tbody = document.getElementById('home-credit-tbody');
        ...
        async fetchData() {
            ...
            try {
                const response = await fetch(`<?= BASE_URL ?>api/home_credit/list.php?${params.toString()}`);
        ...
        exportCSV() {
            // Quick frontend CSV export for simplicity
            const params = new URLSearchParams(new FormData(this.form));
            window.location.href = `<?= BASE_URL ?>api/home_credit/export.php?${params.toString()}`;
        }
    };

    document.addEventListener('DOMContentLoaded', () => HomeCreditTracker.init());
</script>
