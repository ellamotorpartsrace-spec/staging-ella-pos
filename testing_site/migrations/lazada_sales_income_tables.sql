...
-- 3. Lazada Financial Transactions (Escrow Details)
CREATE TABLE IF NOT EXISTS `lazada_financial_transactions` (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
    `order_sn` VARCHAR(50) NOT NULL UNIQUE,
...
-- 4. Lazada Settlements (Payouts)
CREATE TABLE IF NOT EXISTS `lazada_settlements` (
    `id` INT AUTO_INCREMENT PRIMARY KEY,
